...
\verbatim
  ...
  *BAUD115200          115200      115200
   ...
   BAUD500000          500000      500000
   BAUD576000          576000      576000
\endverbatim
*/
...
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
                Posix_CommConfig.c_cflag|=B500000;
#else
                cfsetispeed(&Posix_CommConfig, B500000);
                cfsetospeed(&Posix_CommConfig, B500000);
#endif
                break;
...
#ifdef CBAUD
                Posix_CommConfig.c_cflag&=(~CBAUD);
                Posix_CommConfig.c_cflag|=B576000;
#else
                cfsetispeed(&Posix_CommConfig, B576000);
                cfsetospeed(&Posix_CommConfig, B576000);
#endif
                break;
        }
