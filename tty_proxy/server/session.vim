...
badd +1 mainwindow.h
badd +159 communication.cpp
badd +79 communication.h
badd +0 Makefile
badd +17 server.pro
badd +234 qextserialport.h
badd +44 main.cpp
badd +0 qextserialport_global.h
badd +117 ../tty-proxy-vitas-1.0/server/main.c
badd +193 qextserialport.cpp
badd +65 posix_qextserialport.cpp
badd +63 ~/patient-monitor-gui/alarm.h
badd +0 configuration.h
badd +0 configuration.cpp
args mainwindow.cpp
edit mainwindow.cpp
...
let s:l = 115 - ((41 * winheight(0) + 25) / 50)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 59 - ((35 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
normal! 0
tabedit configuration.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 62 - ((49 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
