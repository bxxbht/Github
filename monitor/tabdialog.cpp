...
void TabDialog::mouseReleaseEvent(QMouseEvent* event)
{
    event->accept();
}
    ...
    : QWidget(parent)
{
    ...
    for (int i = 1; i <= 300; ++i)
        applications.append(tr("abcccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc Application %1").arg(i));
