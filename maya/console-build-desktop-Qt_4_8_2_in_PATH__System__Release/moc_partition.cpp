...
**
** Created: Wed Apr 13 11:49:48 2016
...
static const uint qt_meta_data_Partition[] = {
 ...
 // enum data: key, value
      83, uint(Partition::OK),
      86, uint(Partition::Failed),
      93, uint(Partition::Malformed),
     103, uint(Partition::Incomplted),
     114, uint(Partition::FileNotExist),
     127, uint(Partition::CrcError),
...
static const char qt_meta_stringdata_Partition[] = {
    ...
    "Status\0Error\0OK\0Failed\0Malformed\0"
